...
write.csv(dplyr::select(amazonia_33K_12classes_4bands.rda, -time_series), file = file.path(outputFolder, "amazonia_33K_12classes_4bands.rda.csv"), row.names = FALSE)
